...
@AllArgsConstructor
public final class RangeAttribute implements Attribute {
    public static final ResourceLocation IDENTIFIER = new ResourceLocation(Spellcraft.MOD_ID, "range");
    ...
    public @NotNull AttributeType<?> getType() {
        return SpellcraftAttributeTypes.RANGE;
    }
}
